...
/*!
 * Generated using the Bootstrap Customizer (http://getbootstrap.com/customize/?id=4d81dfc050da9833183269b79b8b25bc)
 * Config saved to config.json and https://gist.github.com/4d81dfc050da9833183269b79b8b25bc
 */
...
! function() {
    ...
    var t, a, n, s, i, r, l;
    if (t = document.getElementById("site-navigation"), t && (a = t.getElementsByTagName("button")[0], "undefined" != typeof a)) {
        if (n = t.getElementsByTagName("ul")[0], "undefined" == typeof n) return void(a.style.display = "none");
        for (n.setAttribute("aria-expanded", "false"), -1 === n.className.indexOf("nav-menu") && (n.className += " nav-menu"), a.onclick = function() {
            ...
            }, s = n.getElementsByTagName("a"), i = n.getElementsByTagName("ul"), r = 0, l = i.length; l > r; r++) i[r].parentNode.setAttribute("aria-haspopup", "true");
        for (r = 0, l = s.length; l > r; r++) s[r].addEventListener("focus", e, !0), s[r].addEventListener("blur", e, !0);
        ! function(e) {
            var t, a, n = e.querySelectorAll(".menu-item-has-children > a, .page_item_has_children > a");
